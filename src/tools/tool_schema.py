...
class SimpleTopicResponse(BaseModel):
    ...
    query: str = Field(..., description="The actual search query string (under 400 characters)")
    ...
    suggested_tool: Literal["general_search", "academic_search", "github_search", "linkedin_search"] = Field(
...
class Subtopic(BaseModel):
    ...
    query: str = Field(..., description="Specific search query for this subtopic (under 400 characters)")
...
class ComplexTopicResponse(BaseModel):
    ...
    topic_complexity: Literal["complex"] = Field("complex", description="Indicates this is a complex topic requiring multiple subtopics")
    main_query: str = Field(..., description="Single search query to use if a backup is needed")
    main_tool: Literal["general_search", "academic_search", "github_search", "linkedin_search"] = Field(
...
subtopic_schema = {
    ...
    "properties": {
        ...
        "query": {"type": "string", "description": "Specific search query for this subtopic (under 400 characters)"},
        "aspect": {"type": "string", "description": "The specific aspect this subtopic covers"},
        "suggested_tool": {
            "type": "string",
            "enum": ["general_search", "academic_search", "github_search", "linkedin_search"],
            "description": "Most appropriate search tool for this subtopic"
        }
    },
    ...
    "parameters": { # Use 'parameters' for Langchain's bind_tools
        ...
        "properties": {
            ...
            "simple_topic": {
                "type": "object",
                "properties": {
                    "query": {"type": "string", "description": "The actual search query string (under 400 characters)"},
                    "aspect": {"type": "string", "description": "The specific aspect or angle of the topic"},
                    "rationale": {"type": "string", "description": "Brief explanation of why this query is relevant"},
                    "suggested_tool": {
                        "type": "string",
                        "enum": ["general_search", "academic_search", "github_search", "linkedin_search"],
                        "description": "Most appropriate search tool for this query"
            ...
            "complex_topic": {
                "type": "object",
                "properties": {
                    "main_query": {"type": "string", "description": "Single search query to use if a backup is needed"},
                    "main_tool": {
                         "type": "string",
                         "enum": ["general_search", "academic_search", "github_search", "linkedin_search"],
                         "description": "Suggested search tool for the main query"
